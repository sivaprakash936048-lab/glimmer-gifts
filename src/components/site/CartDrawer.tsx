          ...
          {items.length > 0 && (
            <div className="border-t border-border p-6 space-y-4">
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 rounded-full bg-foreground py-3.5 text-sm text-background shadow-float transition-transform hover:-translate-y-0.5"
              >
